...
def savings_goal (current_money):
    if int(input("This is the savings goal calculator, you set an item, how much money it costs, how often you will deposit money, and how much, and we will tell you how long it will take to save  for it. Continue(1) Go back to menu(2)")) == 1():
